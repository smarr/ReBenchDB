...
warmup_plot <- function (data_b, b, s, e) {
  ...
  plot <- plot + theme_simple(8)
  plot <- plot + theme(legend.position=c(0.92, .92))
  print(plot)
}
```
...
<dl class="row">
  ...
  <dd class="col-sm-9"><span class="baseline-badge">`r baselineHash6`</span></dd>

  <dt class="col-sm-2">Change</dt>
  <dd class="col-sm-9"><span class="change-badge">`r changeHash6`</span></dd>
</dl>
